...
# 2. 安装插件
python thingsboard_gateway/tools/plugin_installer.py install modbus_plugin.zip
...
```bash
# 打包
python thingsboard_gateway/tools/plugin_packager.py SOURCE -o plugin.zip -t TYPE -v VERSION
